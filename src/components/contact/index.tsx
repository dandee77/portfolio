  ...
  return (
    ...
    >
      ...
      >
        ...
        <Magnetic>
          <a
            href="https://www.linkedin.com/in/dandee77/"
            target="_blank"
            className="flex gap-x-2 rounded-full border-dark border-2 px-2 py-1"
          >
            <Linkedin />
      ...
      >
        ...
        <p className="poppins-extralight text-2xl">Dandee Galang</p>

        <p className="poppins-light px-4 text-gray-3 tracking-[calc(-1rem*0.03)] mt-[8vh] select-none mb-1 text-center">
          © Dandee Galang {new Date().getFullYear()}. All rights reserved.
        </p>
